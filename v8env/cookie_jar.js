...
export default class CookieJar {
  constructor (parent) {
    this.parent = parent
    if (parent instanceof Request) { this.cookies = parseCookies(parent.headers.getAll('Cookie')) } else if (parent instanceof Response) { this.cookies = parseCookies(parent.headers.getAll('Set-Cookie')) }
  }
  ...
  append (name, value, options) {
    ...
    if (this.parent instanceof Request) { this.parent.headers.append('Cookie', cookieStr) } else if (this.parent instanceof Response) { this.parent.headers.append('Set-Cookie', cookieStr) }
  }
}
